...
// ----------------------------------------------------------------------------
// 'SWAY' 'Sway Token' token contract
//
// Symbol      : SWAY
// Name        : Sway Token
...
// fixed supply
// ----------------------------------------------------------------------------
contract SwayToken is ERC20Interface, Owned {
    ...
    // ------------------------------------------------------------------------
    function balanceOfInEth(address tokenOwner, uint conversionRate) public view returns (uint balance) {
        return balances[tokenOwner] * conversionRate;
    }
